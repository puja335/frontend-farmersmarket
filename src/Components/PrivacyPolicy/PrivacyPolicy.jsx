...
import { Security, Storage, Visibility, VerifiedUser } from '@mui/icons-material';
                ...
                <Container>
                    ...
                    <div className="bg-white rounded-xl p-8 shadow-md mb-8">
                        ...
                        <p className="text-gray-600 mt-4">
                            ...
                            use, and protect your personal information when you use our grocery delivery service.
                        </p>
                    </div>
