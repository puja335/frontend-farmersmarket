...
const PopUpDialog = ({
  ...
  return (
    <Dialog TransitionComponent={transition} open={open} onClose={handleCancel}>
      <div
        className={`lg:w-96 ${
          placeOrder ? "sm:h-56 h-[12.5rem]" : "h-[9rem] sm:h-[11.5rem]"
        } sm:w-[20rem] w-[17.5rem] items-center flex justify-center text-center`}
      >
        <div
          className={
            !placeOrder ? "sm:space-y-11 space-y-8" : "md:space-y-9 space-y-7"
          }
        >
          <div className='space-y-5'>
            ...
            <h3
              className={`${
                !placeOrder ? "sm:text-lg" : "text-base"
