...
import { Shield, Lock, Security, Payment } from '@mui/icons-material';
    ...
    const securityFeatures = [
        {
            ...
            description: "All payments are processed through encrypted channels using industry-standard SSL technology."
        },
        {
            icon: <Shield className="text-green-600 text-4xl" />,
            title: "Data Protection",
            description: "Your personal information is protected with advanced encryption and secure storage protocols."
        },
        {
            icon: <Payment className="text-green-600 text-4xl" />,
            title: "Safe Payments",
            description: "Multiple secure payment options including credit cards, digital wallets, and cash on delivery."
        },
        {
            icon: <Security className="text-green-600 text-4xl" />,
            title: "Verified Vendors",
            description: "All our suppliers undergo strict verification processes to ensure reliability and quality."
        }
    ];
